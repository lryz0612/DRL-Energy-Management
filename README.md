...
<div align="center"><img height="350" src="https://github.com/lryz0612/Image/blob/master/DRL.jpg"/></div>
 ...
 ## Simulation results
We make extensive comparison experiments between RI DDPG and RI deep Q learning (DQL), wherein they share the same embedded expert knowledge. The performance of the two models are evaluated according to the evaluation metrics defined in section 3.3.
